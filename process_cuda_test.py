...
slice = [3,4]
infile = '/home/thomas/Documents/thesis/LyapunovConvexOptimization/cuda-roa/SphericalSk8/Lyapunov/X3X4_initial_states.bin'
finfile = '/home/thomas/Documents/thesis/LyapunovConvexOptimization/cuda-roa/SphericalSk8/Lyapunov/X3X4_final_states.bin'
# infile = '/home/thomas/Documents/thesis/LyapunovConvexOptimization/cuda-roa/initial_states.bin'
# finfile = '/home/thomas/Documents/thesis/LyapunovConvexOptimization/cuda-roa/final_states.bin'
# Read binary files
...
for _ in range(len(final_states)):
    ...
    # atFixedPt = np.allclose(final_states[_, [1,2,3]], x0[[1,2,3]], atol=0.03) and np.allclose(final_states[_, [5,6,7]], x0[[5,6,7]], atol=0.1)
